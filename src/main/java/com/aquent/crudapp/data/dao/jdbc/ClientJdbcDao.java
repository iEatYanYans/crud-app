...
public class ClientJdbcDao implements ClientDao{
	 ...
	 private static final String SQL_LIST_CLIENTS = "SELECT * FROM client ORDER BY client_id, company_name";
	 ...
	 private static final String SQL_UPDATE_CLIENT = "UPDATE client SET (company_name, url, phone_number, street_address, city, state, zip_code)"
	                                                  + " = (:companyName, :url, :phoneNumber, :streetAddress, :city, :state, :zipCode)"
	                                                  + " WHERE client_id = :clientId";
	 private static final String SQL_CREATE_CLIENT = "INSERT INTO client (company_name, url, phone_number, street_address, city, state, zip_code)"
	                                                  + " VALUES (:companyName, :url, :phoneNumber, :streetAddress, :city, :state, :zipCode)";
	 // private static final String SQL_READ_PERSONS = "SELECT * FROM person WHERE client_id = :clientId";
